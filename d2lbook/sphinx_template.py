...
'preamble': r'''
\usepackage[asymmetric]{geometry}  %%DAT added assymetric option
\usepackage{graphicx}
\usepackage{booktabs}
\usepackage{amsthm}
\usepackage{color}
...
%\usepackage{times}  %%DAT tried to comment out and replace with newtx but caused issues  with \DeclareRobustCommand{\sustyle}{% 
